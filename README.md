...
These .3mf files were edited and saved using the "Orca Slicer" program. before you print with them, remember to change the profile of the printer to your own printer instead of the "Creality Ender 3 v3 SE" that I used to print them!
...
5. The LED diffuser ring - This piece is unchanged from the OEM design.


Finally, the 8" USB-C cables I bought were purchased here: https://www.amazon.com/dp/B0CTDNBZ5S
The description of the cable: "2Pack 90 Degree USB-C Extension Cable Flat 8inch.USB2.0 C Male to Female Adapter, Soft Right Angle USB C to C Cable. Only Compatible with of 66W and Below."
